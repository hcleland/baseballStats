...
namespace baseballStatistics.Migrations
{
    ...
    [Migration("20190905195829_seedData")]
            ...
            modelBuilder.Entity("baseballStatistics.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "00000000-ffff-ffff-ffff-ffffffffffff", AccessFailedCount = 0, ConcurrencyStamp = "4183ffbd-0e01-4248-b930-9d44c2fb80c3", Email = "parent@mail.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "PARENT@MAIL.COM", NormalizedUserName = "PARENT@MAIL.COM", PasswordHash = "AQAAAAEAACcQAAAAEH51y73rqS5GntyurjqYmUMIuTlBwM6Vqy+0YbRVBIZKoYp3J3wwaRQQHnyZ82JoDA==", PhoneNumber = "615-555-5555", PhoneNumberConfirmed = false, SecurityStamp = "7f434309-a4d9-48e9-9ebb-8803db794577", TwoFactorEnabled = false, UserName = "parent@mail.com", FirstName = "Ima", IsCoach = false, LastName = "Parent" }
                    );
                });
