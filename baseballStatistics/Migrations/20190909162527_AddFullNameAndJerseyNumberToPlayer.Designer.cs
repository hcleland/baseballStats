...
namespace baseballStatistics.Migrations
{
    ...
    [Migration("20190909162527_AddFullNameAndJerseyNumberToPlayer")]
    partial class AddFullNameAndJerseyNumberToPlayer
    {
            ...
            modelBuilder.Entity("baseballStatistics.Models.Player", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Age = 9, ApplicationUserId = "00000000-ffff-ffff-ffff-ffffffffffff", FirstName = "Johnny", JerseyNumber = 0, LastName = "Jones", Nickname = "JJ", Position = "Shortstop", TeamId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("baseballStatistics.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "00000000-ffff-ffff-ffff-ffffffffffff", AccessFailedCount = 0, ConcurrencyStamp = "eb1a35e0-0aa9-49d6-b374-ce755c796f6b", Email = "parent@mail.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "PARENT@MAIL.COM", NormalizedUserName = "PARENT@MAIL.COM", PasswordHash = "AQAAAAEAACcQAAAAEGSKUJDFThz4zBTlC3uCYkpSa7hYdsDCIaViR5D6t/APc4wXWsgGZd0DdTBFIvLgtQ==", PhoneNumber = "615-555-5555", PhoneNumberConfirmed = false, SecurityStamp = "7f434309-a4d9-48e9-9ebb-8803db794577", TwoFactorEnabled = false, UserName = "parent@mail.com", FirstName = "Ima", IsCoach = false, LastName = "Parent" }
                    );
                });
